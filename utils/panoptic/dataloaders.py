...
from ..dataloaders import InfiniteDataLoader, LoadImagesAndLabels, seed_worker, get_hash, verify_image_label, HELP_URL, \
	TQDM_BAR_FORMAT, LOCAL_RANK
...
class LoadImagesAndLabelsAndMasks(LoadImagesAndLabels):  # for training/testing
	...
	def load_mosaic(self, index):
		...
		for i, index in enumerate(indices):
			...
			labels, segments, semantic_masks = self.labels[index].copy(), self.segments[index].copy(), self.semantic_masks[
				index].copy()
		...
		# 3 additional image indices
		# Augment
		img4, labels4, segments4, seg_cls, semantic_masks4 = copy_paste(img4, labels4, segments4, seg_cls, semantic_masks4,
