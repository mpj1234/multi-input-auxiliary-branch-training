...
from models.yolo import ClassificationModel, Detect, DDetect, DualDetect, DualDDetect, DetectionModel, \
	SegmentationModel, DBBDualDDetect
...
def run(
	...
	for k, m in model.named_modules():
		if isinstance(m, (Detect, DDetect, DualDetect, DualDDetect, DBBDualDDetect)):
			m.inplace = inplace
			m.dynamic = dynamic
			m.export = True
